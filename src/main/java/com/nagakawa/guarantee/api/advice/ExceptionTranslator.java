...
import com.nagakawa.guarantee.api.exception.InternalServerErrorException;
import com.nagakawa.guarantee.api.exception.NoPermissionException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
	...
	public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity, NativeWebRequest request) {
		...
		ProblemBuilder builder = Problem.builder()
				...
				.with(ApiConstants.ErrorKey.PATH, request.getNativeRequest(HttpServletRequest.class).getRequestURI());
